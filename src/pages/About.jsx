    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
          <p>Forever was born ouf of a passion for innovation and a desire to revolutionize the way
          ...
          <p>Since our inception, we've worked tirelessly to curate a diverse selection of high-quality
            ...
            electronics and home essentiais. we ofter an extensive collection sourced from trusted.
            brands and suppliers.</p>
          <b className='text-gray-800'>Our Mission</b>
          <p>Our mission at Forever is to embower customers with choice, convenience. and
            contidence. We re dedicated to providing a seamless shopping experience that exceeds
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        ...
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Convenience:</b>
          <p className='text-gray-600'>
            With our user-friendly interface and hossie-
